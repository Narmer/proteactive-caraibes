  ...
  e.fn.prettyPhoto = function(s) {
    function g() {
      ...
      $pp_pic_holder.animate({
        ...
        isSet && S(pp_images[set_position]) == "image" ? $pp_pic_holder.find(".pp_hoverContainer").show() : $pp_pic_holder.find(".pp_hoverContainer").hide();
        settings.allow_expand && (a.resized ? e("a.pp_expand,a.pp_contract").show() : e("a.pp_expand").hide());
        settings.autoplay_slideshow && !m && !f && e.prettyPhoto.startSlideshow();
    ...
    function E(t, n) {
      ...
      e.browser.msie && e.browser.version == 7 && (detailsHeight += 8);
      $pp_details.remove();
    ...
    function N() {
      ...
      typeof $pp_overlay != "undefined" && $pp_overlay.height(e(document).height()).width(v);
    }
    function C() {
    ...
    var o = this, u = !1, a, f, l, c, h, p, d = e(window).height(), v = e(window).width(), m;
    doresize = !0, scroll_pos = T();
    ...
    e.prettyPhoto.initialize = function() {
      settings = s;
      settings.theme == "pp_default" && (settings.horizontal_padding = 16);
      settings.ie6_fallback && e.browser.msie && parseInt(e.browser.version) == 6 && (settings.theme = "light_square");
    ...
    e.prettyPhoto.open = function(t) {
      if (typeof settings == "undefined") {
        settings = s;
        e.browser.msie && e.browser.version == 6 && (settings.theme = "light_square");
      ...
      e.browser.msie && e.browser.version == 6 && e("select").css("visibility", "hidden");
      ...
      typeof pp_descriptions[set_position] != "undefined" && pp_descriptions[set_position] != "" ? $pp_pic_holder.find(".pp_description").show().html(unescape(pp_descriptions[set_position])) : $pp_pic_holder.find(".pp_description").hide();
      ...
      $pp_pic_holder.fadeIn(function() {
        ...
        switch (S(pp_images[set_position])) {
         ...
         case "vimeo":
          ...
          var t = /http:\/\/(www\.)?vimeo.com\/(\d+)/, n = movie_id.match(t);
    ...
    e.prettyPhoto.close = function() {
      ...
      $pp_overlay.fadeOut(settings.animation_speed, function() {
        e.browser.msie && e.browser.version == 6 && e("select").css("visibility", "visible");
