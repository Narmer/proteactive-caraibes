(function(e, t, n) {
  ...
  t.elastislide.prototype = {
    ...
    _addControls: function() {
      this.$navNext = t('<span class="es-nav-next"><i class="icon-chevron-right"></i></span>');
      this.$navPrev = t('<span class="es-nav-prev"><i class="icon-chevron-left"></i></span>');
    ...
    _slide: function(e, r, i, s) {
      ...
      if (r === n) {
        var u = this.fitCount * this.itemW, r;
        if (u < 0) return !1;
