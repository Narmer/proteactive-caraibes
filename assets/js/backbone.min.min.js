(function() {
  ...
  i.Events = {
    ...
    off: function(e, t, n) {
      var r, i, s;
      if (e) {
        if (i = this._callbacks) for (e = e.split(/\s+/); r = e.shift(); ) if (s = i[r], delete i[r], t && s) for (; (s = s.next) && s.next; ) (s.callback !== t || !!n && s.context !== n) && this.on(r, s.callback, s.context);
    ...
    trigger: function(e) {
      ...
      for (s = n.call(arguments, 1); r = e.pop(); ) {
        t = r.tail;
        for (i = r.event ? [ r.event ].concat(s) : s; (r = r.next) !== t; ) r.callback.apply(r.context || this, i);
      }
      return this;
    }
  };
  i.Events.bind = i.Events.on;
  i.Events.unbind = i.Events.off;
  ...
  s.extend(i.Model.prototype, i.Events, {
    ...
    escape: function(e) {
      ...
      t = this.attributes[e];
      return this._escapedAttributes[e] = s.escape(null == t ? "" : "" + t);
    },
    has: function(e) {
    ...
    set: function(e, t, n) {
      ...
      if (n.unset) for (o in r) r[o] = void 0;
      if (!this._validate(r, n)) return !1;
      this.idAttribute in r && (this.id = r[this.idAttribute]);
      var t = this.attributes, u = this._escapedAttributes, a = this._previousAttributes || {}, f = this._setting;
      this._changed || (this._changed = {});
      this._setting = !0;
      for (o in r) if (e = r[o], s.isEqual(t[o], e) || delete u[o], n.unset ? delete t[o] : t[o] = e, this._changing && !s.isEqual(this._changed[o], e) && (this.trigger("change:" + o, this, e, n), this._moreChanges = !0), delete this._changed[o], !s.isEqual(a[o], e) || s.has(t, o) != s.has(a, o)) this._changed[o] = e;
      f || (!n.silent && this.hasChanged() && this.change(n), this._setting = !1);
      return this;
    },
    unset: function(e, t) {
      (t || (t = {})).unset = !0;
    ...
    clear: function(e) {
      (e || (e = {})).unset = !0;
      return this.set(s.clone(this.attributes), e);
    },
    fetch: function(e) {
      var e = e ? s.clone(e) : {}, t = this, n = e.success;
    ...
    save: function(e, t, n) {
      ...
      s.isObject(e) || null == e ? (r = e, n = t) : (r = {}, r[e] = t);
      n = n ? s.clone(n) : {};
      n.wait && (o = s.clone(this.attributes));
      e = s.extend({}, n, {
        silent: !0
      });
    ...
    destroy: function(e) {
      var e = e ? s.clone(e) : {}, t = this, n = e.success, r = function() {
    ...
    changedAttributes: function(e) {
      ...
      var t, n = !1, r = this._previousAttributes, i;
    ...
    _validate: function(e, t) {
      ...
      var e = s.extend({}, this.attributes, e), n = this.validate(e, t);
      if (!n) return !0;
      t && t.error ? t.error(this, n, t) : this.trigger("error", this, n, t);
      return !1;
    }
  });
  ...
  s.extend(i.Collection.prototype, i.Events, {
    ...
    remove: function(e, t) {
      ...
      t || (t = {});
      e = s.isArray(e) ? e.slice() : [ e ];
      for (n = 0, r = e.length; n < r; n++) if (o = this.getByCid(e[n]) || this.get(e[n])) delete this._byId[o.id], delete this._byCid[o.cid], i = this.indexOf(o), this.models.splice(i, 1), this.length--, t.silent || (t.index = i, o.trigger("remove", o, this, t)), this._removeReference(o);
      return this;
    },
    get: function(e) {
    ...
    sort: function(e) {
      ...
      1 == this.comparator.length ? this.models = this.sortBy(t) : this.models.sort(t);
    ...
    create: function(e, t) {
      var n = this, t = t ? s.clone(t) : {}, e = this._prepareModel(e, t);
      if (!e) return !1;
      t.wait || n.add(e, t);
      var r = t.success;
      t.success = function(i, s) {
        t.wait && n.add(i, t);
    ...
    _prepareModel: function(e, t) {
      e instanceof i.Model ? e.collection || (e.collection = this) : (t.collection = this, e = new this.model(e, t), e._validate(e.attributes, t) || (e = !1));
      return e;
    },
  ...
  s.extend(i.Router.prototype, i.Events, {
    ...
    _routeToRegExp: function(e) {
      e = e.replace(f, "\\$&").replace(u, "([^/]+)").replace(a, "(.*?)");
      return RegExp("^" + e + "$");
    },
  ...
  s.extend(i.History.prototype, i.Events, {
    ...
    getFragment: function(e, t) {
      if (null == e) if (this._hasPushState || t) {
        var e = window.location.pathname, n = window.location.search;
        n && (e += n);
      } else e = window.location.hash;
      e = decodeURIComponent(e);
      e.indexOf(this.options.root) || (e = e.substr(this.options.root.length));
      return e.replace(l, "");
    },
    start: function(e) {
      ...
      var e = this.getFragment(), t = document.documentMode;
  ...
  var p = /^(\S+)\s*(.*)$/, d = "model,collection,el,id,attributes,className,tagName".split(",");
    ...
    delegateEvents: function(e) {
      if (e || (e = y(this, "events"))) {
        ...
        for (var t in e) {
          ...
          var r = t.match(p), i = r[1], r = r[2], n = s.bind(n, this), i = i + (".delegateEvents" + this.cid);
  ...
  var m = function() {}, g = function(e, t, n) {
    var r;
