(function(e, t) {
  ...
  var D = e.document, P = e.navigator, H = e.location, B = function() {
    ...
    r.fn = r.prototype = {
      ...
      init: function(e, n, i) {
        ...
        if (e === "body" && !n && D.body) {
          this.context = D, this[0] = D.body, this.selector = e, this.length = 1;
          return this;
        }
        if (typeof e == "string") {
          ...
          if (s && (s[1] || !n)) {
            if (s[1]) {
              n = n instanceof r ? n[0] : n, f = n ? n.ownerDocument || n : D, a = c.exec(e), a ? r.isPlainObject(n) ? (e = [ D.createElement(a[1]) ], r.fn.attr.call(e, n, !0)) : e = [ f.createElement(a[1]) ] : (a = r.buildFragment([ s[1] ], [ f ]), e = (a.cacheable ? r.clone(a.fragment) : a.fragment).childNodes);
  ...
  B.extend({
    ...
    a.removeChild(d), a = i = s = u = d = o = null, B(function() {
  ...
  B.extend({
    ...
    data: function(e, n, r, i) {
      if (!!B.acceptData(e)) {
        ...
        s = o = c[h], i || (o.data || (o.data = {}), o = o.data), r !== t && (o[B.camelCase(n)] = r);
    ...
    data: function(e, n) {
      ...
      if (n === t) {
        o = this.triggerHandler("getData" + r[1] + "!", [ r[0] ]), o === t && this.length && (o = B.data(this[0], e), o = M(this[0], e, o));
    ...
    queue: function(e, t, n) {
      var r;
      if (e) {
        t = (t || "fx") + "queue", r = B._data(e, t), n && (!r || B.isArray(n) ? r = B._data(e, t, B.makeArray(n)) : r.push(n));
        return r || [];
      }
    },
    ...
    queue: function(e, n) {
      ...
      return n === t ? B.queue(this[0], e) : this.each(function() {
  ...
  B.fn.extend({
    ...
    prop: function(e, n, r) {
      ...
      if (!!e && u !== 3 && u !== 8 && u !== 2) {
        o = u !== 1 || !B.isXMLDoc(e), o && (n = B.propFix[n] || n, s = B.propHooks[n]);
    ...
    set: function(e, t, n) {
      var r;
      t === !1 ? B.removeAttr(e, n) : (r = B.propFix[n] || n, r in e && (e[r] = !0), e.setAttribute(n, n.toLowerCase()));
      return n;
    }
  }, J || (G = {
    name: !0,
    ...
    get: function(e, n) {
      ...
      return r && (G[n] ? r.nodeValue !== "" : r.specified) ? r.nodeValue : t;
    },
    set: function(e, t, n) {
  ...
  B.event = {
    ...
    trigger: function(n, r, i, s) {
      if (!i || i.nodeType !== 3 && i.nodeType !== 8) {
        ...
        n.type = o, !s && !n.isDefaultPrevented() && (!d._default || d._default.apply(i.ownerDocument, r) === !1) && (o !== "click" || !B.nodeName(i, "a")) && B.acceptData(i) && p && i[o] && (o !== "focus" && o !== "blur" || n.target.offsetWidth !== 0) && !B.isWindow(i) && (h = i[p], h && (i[p] = null), B.event.triggered = o, i[o](), B.event.triggered = t, h && (i[p] = h));
        return n.result;
      }
    },
    dispatch: function(n) {
    ...
    mouseHooks: {
      ...
      filter: function(e, n) {
        ...
        e.pageX == null && n.clientX != null && (r = e.target.ownerDocument || D, i = r.documentElement, s = r.body, e.pageX = n.clientX + (i && i.scrollLeft || s && s.scrollLeft || 0) - (i && i.clientLeft || s && s.clientLeft || 0), e.pageY = n.clientY + (i && i.scrollTop || s && s.scrollTop || 0) - (i && i.clientTop || s && s.clientTop || 0)), !e.relatedTarget && u && (e.relatedTarget = u === e.target ? n.toElement : u), !e.which && o !== t && (e.which = o & 1 ? 1 : o & 2 ? 3 : o & 4 ? 2 : 0);
        return e;
      }
    },
    fix: function(e) {
      ...
      e.target || (e.target = i.srcElement || D), e.target.nodeType === 3 && (e.target = e.target.parentNode), e.metaKey === t && (e.metaKey = e.ctrlKey);
    ...
    off: function(e, n, r) {
      if (e && e.preventDefault && e.handleObj) {
        var i = e.handleObj;
        B(e.delegateTarget).off(i.namespace ? i.type + "." + i.namespace : i.type, i.selector, i.handler);
        return this;
      }
      if (typeof e == "object") {
  ...
  B.fn.extend({
    ...
    B.fn[e] = function(n, r) {
      ...
      at.test(e) || (r = n), r && typeof r == "string" && (i = B.filter(r, i)), i = this.length > 1 && !dt[e] ? B.unique(i) : i, (this.length > 1 || lt.test(r)) && ft.test(e) && (i = i.reverse());
  ...
  Lt.optgroup = Lt.option, Lt.tbody = Lt.tfoot = Lt.colgroup = Lt.caption = Lt.thead, Lt.th = Lt.td, B.support.htmlSerialize || (Lt._default = [ 1, "div<div>", "</div>" ]), B.fn.extend({
    ...
    var r, i, s, o, u = e[0];
    t && t[0] && (o = t[0].ownerDocument || t[0]), o.createDocumentFragment || (o = D), e.length === 1 && typeof u == "string" && u.length < 512 && o === D && u.charAt(0) === "<" && !xt.test(u) && (B.support.checkClone || !Nt.test(u)) && (B.support.html5Clone || !Tt.test(u)) && (i = !0, s = B.fragments[u], s && s !== 1 && (r = s)), r || (r = o.createDocumentFragment(), B.clean(e, o, r, n)), i && (B.fragments[u] = s ? r : 1);
    return {
      fragment: r,
      cacheable: i
    };
  ...
  B.fn.css = function(e, n) {
    ...
    var n, r, i;
    t = t.replace(_t, "-$1").toLowerCase(), (r = e.ownerDocument.defaultView) && (i = r.getComputedStyle(e, null)) && (n = i.getPropertyValue(t), n === "" && !B.contains(e.ownerDocument.documentElement, e) && (n = B.style(e, t)));
    return n;
  }), D.documentElement.currentStyle && (Rt = function(e, t) {
    var n, r, i, s = e.currentStyle && e.currentStyle[t], o = e.style;
    s === null && o && (i = o[t]) && (s = i), !Dt.test(s) && Pt.test(s) && (n = o.left, r = e.runtimeStyle && e.runtimeStyle.left, r && (e.runtimeStyle.left = e.currentStyle.left), o.left = t === "fontSize" ? "1em" : s || 0, s = o.pixelLeft + "px", o.left = n, r && (e.runtimeStyle.left = r));
    return s === "" ? "auto" : s;
  ...
  B.ajaxSetup({
    ...
    if (t.dataTypes[0] === "jsonp" || t.jsonp !== !1 && (hn.test(t.url) || i && hn.test(t.data))) {
      ...
      t.jsonp !== !1 && (a = a.replace(hn, l), t.url === a && (i && (f = f.replace(hn, l)), t.data === f && (a += (/\?/.test(a) ? "&" : "?") + t.jsonp + "=" + o))), t.url = a, t.data = f, e[o] = function(e) {
        s = [ e ];
      }, r.always(function() {
  ...
  B.fn.extend({
    ...
    toggle: function(e, t, n) {
      ...
      B.isFunction(e) && B.isFunction(t) ? this._toggle.apply(this, arguments) : e == null || r ? this.each(function() {
    ...
    step: function(e) {
      ...
      a.duration == Infinity ? this.now = i : (n = i - this.startTime, this.state = n / a.duration, this.pos = B.easing[a.animatedProperties[this.prop]](this.state, n, 0, 1, a.duration), this.now = this.start + (this.end - this.start) * this.pos), this.update();
      return !0;
    }
  }, B.extend(B.fx, {
    tick: function() {
  ...
  "getBoundingClientRect" in D.documentElement ? B.fn.offset = function(e) {
    ...
    B.support.fixedPosition && f.position === "fixed" && (l += Math.max(o.scrollTop, u.scrollTop), c += Math.max(o.scrollLeft, u.scrollLeft));
    return {
      top: l,
      left: c
    };
    ...
    bodyOffset: function(e) {
      ...
      B.support.doesNotIncludeMarginInBodyOffset && (t += parseFloat(B.css(e, "marginTop")) || 0, n += parseFloat(B.css(e, "marginLeft")) || 0);
      return {
        top: t,
        left: n
      };
    ...
    position: function() {
      ...
      n.top -= parseFloat(B.css(e, "marginTop")) || 0, n.left -= parseFloat(B.css(e, "marginLeft")) || 0, r.top += parseFloat(B.css(t[0], "borderTopWidth")) || 0, r.left += parseFloat(B.css(t[0], "borderLeftWidth")) || 0;
      return {
        top: n.top - r.top,
        left: n.left - r.left
      };
    ...
    B.fn[i] = function(r) {
      ...
      if (r === t) {
        ...
        if (!s) return null;
        o = n(s);
        return o ? "pageXOffset" in o ? o[e ? "pageYOffset" : "pageXOffset"] : B.support.boxModel && o.document.documentElement[i] || o.document.body[i] : s[i];
      }
      return this.each(function() {
