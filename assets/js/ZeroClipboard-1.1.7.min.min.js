(function() {
  ...
  var e = function(e, t) {
    ...
    if (n == "auto" && t == "cursor") {
      var r = [ "a" ];
      for (var i = 0; i < r.length; i++) if (e.tagName.toLowerCase() == r[i]) return "pointer";
    }
    return n;
  }, t = function(e) {
    ...
    while (t) {
      var i = parseInt(e(t, "borderLeftWidth"), 10), s = parseInt(e(t, "borderTopWidth"), 10);
  ...
  var v = function() {
    var e = c.prototype._singleton, t = document.getElementById("global-zeroclipboard-html-bridge");
    if (!t) {
  ...
  c.prototype.resetBridge = function() {
    ...
    switch (e) {
     ...
     case "mouseup":
      ...
      break;
     case "datarequested":
      var r = n.getAttribute("data-clipboard-target"), o = r ? document.getElementById(r) : null;
      if (o) {
