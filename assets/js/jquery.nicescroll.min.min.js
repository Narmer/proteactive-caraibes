(function(e) {
  var t = !1, n = !1, r = 5e3, i = 2e3, s = 0, o, u = document.getElementsByTagName("script"), u = u[u.length - 1].src.split("?")[0];
  o = 0 < u.split("/").length ? u.split("/").slice(0, -1).join("/") + "/" : "";
  Array.prototype.forEach || (Array.prototype.forEach = function(e, t) {
    for (var n = 0, r = this.length; n < r; ++n) e.call(t, this[n], n, this);
  });
  var f = window.requestAnimationFrame || !1, l = window.cancelAnimationFrame || !1;
  [ "ms", "moz", "webkit", "o" ].forEach(function(e) {
    f || (f = window[e + "RequestAnimationFrame"]);
    l || (l = window[e + "CancelAnimationFrame"] || window[e + "CancelRequestAnimationFrame"]);
  });
  var c = window.MutationObserver || window.WebKitMutationObserver || !1, h = {
    zindex: "auto",
    cursoropacitymin: 0,
    cursoropacitymax: 1,
    cursorcolor: "#424242",
    ...
    function m(e, t, n) {
      t = e.css(t);
      e = parseFloat(t);
      return isNaN(e) ? (e = P[t] || 0, n = 3 == e ? n ? b.win.outerHeight() - b.win.innerHeight() : b.win.outerWidth() - b.win.innerWidth() : 1, b.isie8 && e && (e += 1), n ? e : 0) : e;
    }
    function g(e, t, n, r) {
    ...
    if (u) for (var w in b.opt) "undefined" != typeof u[w] && (b.opt[w] = u[w]);
    ...
    if (p) w = p; else {
      ...
      E.isie = "all" in document && "attachEvent" in w && !E.isopera;
      E.isieold = E.isie && !("msInterpolationMode" in w.style);
      ...
      E.ismozilla = "MozAppearance" in w.style;
      E.iswebkit = "WebkitAppearance" in w.style;
      E.ischrome = "chrome" in window;
      E.ischrome22 = E.ischrome && E.haspointerlock;
      E.ischrome26 = E.ischrome && "transition" in w.style;
      ...
      E.hastransition = !1;
      E.transitionend = !1;
      for (var S = [ "transform", "msTransform", "webkitTransform", "MozTransform", "OTransform" ], T = 0; T < S.length; T++) if ("undefined" != typeof w.style[S[T]]) {
        E.trstyle = S[T];
        break;
      }
      E.hastransform = 0 != E.trstyle;
      E.hastransform && (w.style[E.trstyle] = "translate3d(1px,2px,3px)", E.hastranslate3d = /translate3d/.test(w.style[E.trstyle]));
      E.transitionstyle = !1;
      E.prefixstyle = "";
      E.transitionend = !1;
      for (var S = "transition webkitTransition MozTransition OTransition OTransition msTransition KhtmlTransition".split(" "), k = " -webkit- -moz- -o- -o -ms- -khtml-".split(" "), A = "transitionend webkitTransitionEnd transitionend otransitionend oTransitionEnd msTransitionEnd KhtmlTransitionEnd".split(" "), T = 0; T < S.length; T++) if (S[T] in w.style) {
        E.transitionstyle = S[T];
        E.prefixstyle = k[T];
        E.transitionend = A[T];
        break;
      }
      E.ischrome26 && (E.prefixstyle = k[1]);
      E.hastransition = E.transitionstyle;
      e : {
        S = [ "-moz-grab", "-webkit-grab", "grab" ];
        if (E.ischrome && !E.ischrome22 || E.isie) S = [];
        for (T = 0; T < S.length; T++) if (k = S[T], w.style.cursor = k, w.style.cursor == k) {
          S = k;
          break e;
        }
        S = "url(http://www.google.com/intl/en_ALL/mapfiles/openhand.cur),n-resize";
      }
      E.cursorgrabvalue = S;
      E.hasmousecapture = "setCapture" in w;
      E.hasMutationObserver = !1 !== c;
      w = null;
      w = p = E;
    }
    this.detected = w;
    var M = e.extend({}, this.detected);
    this.ishwscroll = (this.canhwscroll = M.hastransform && b.opt.hwacceleration) && b.haswrapper;
    this.istouchcapable = !1;
    M.cantouch && M.ischrome && !M.isios && !M.isandroid && (this.istouchcapable = !0, M.cantouch = !1);
    M.cantouch && M.ismozilla && !M.isios && (this.istouchcapable = !0, M.cantouch = !1);
    b.opt.enablemouselockapi || (M.hasmousecapture = !1, M.haspointerlock = !1);
    ...
    if (this.ishwscroll) {
      ...
      this.getScrollLeft = function(e) {
        if (!e) {
          if (e = _()) return 16 == e.length ? -e[12] : -e[4];
      ...
      M.hastranslate3d && b.opt.enabletranslate3d ? (this.setScrollTop = function(e, t) {
        b.doc.translate.y = e;
        b.doc.translate.ty = -1 * e + "px";
        b.doc.css(M.trstyle, "translate3d(" + b.doc.translate.tx + "," + b.doc.translate.ty + ",0px)");
        ...
        b.doc.translate.y = e;
        b.doc.translate.ty = -1 * e + "px";
        b.doc.css(M.trstyle, "translate(" + b.doc.translate.tx + "," + b.doc.translate.ty + ")");
        t || b.notifyScrollEvent(b.win[0]);
      }, this.setScrollLeft = function(e, t) {
        b.doc.translate.x = e;
        b.doc.translate.tx = -1 * e + "px";
    ...
    this.init = function() {
      b.saved.css = [];
      if (M.isie7mobile) return !0;
      M.hasmstouch && b.css(b.ispage ? e("html") : b.win, {
      ...
      if (!b.ispage || !M.cantouch && !M.isieold && !M.isie9mobile) {
        var i = b.docscroll;
        b.ispage && (i = b.haswrapper ? b.win : b.doc);
        M.isie9mobile || b.css(i, {
          "overflow-y": "hidden"
        });
        b.ispage && M.isie7 && ("BODY" == b.doc[0].nodeName ? b.css(e("html"), {
          "overflow-y": "hidden"
        }) : "HTML" == b.doc[0].nodeName && b.css(e("body"), {
          "overflow-y": "hidden"
        }));
        M.isios && !b.ispage && !b.haswrapper && b.css(e("body"), {
        ...
        var f, l, h = [ "left", "right" ], p;
        for (p in h) l = h[p], (f = b.opt.railpadding[l]) ? a.css("padding-" + l, f + "px") : b.opt.railpadding[l] = 0;
        a.append(u);
        ...
        b.rail = a;
        u = b.rail.drag = !1;
        b.opt.boxzoom && !b.ispage && !M.isieold && (u = document.createElement("div"), b.bind(u, "click", b.doZoom), b.zoom = e(u), b.zoom.css({
          cursor: "pointer",
          "z-index": b.zindex,
        ...
        }), b.opt.dblclickzoom && b.bind(b.win, "dblclick", b.doZoom), M.cantouch && b.opt.gesturezoom && (b.ongesturezoom = function(e) {
        ...
        b.ispage ? (a.css({
          ...
          top: 0
        }), i.append(m))) : (b.isfixed = "fixed" == b.win.css("position"), i = b.isfixed ? "fixed" : "absolute", b.isfixed || (b.viewport = b.getViewport(b.win[0])), b.viewport && (b.body = b.viewport, 0 == /relative|absolute/.test(b.viewport.css("position")) && b.css(b.viewport, {
          position: "relative"
        })), a.css({
          position: i
        }), b.zoom && b.zoom.css({
          ...
          position: i
        }), b.body.append(m))), M.isios && b.css(b.win, {
          "-webkit-tap-highlight-color": "rgba(0,0,0,0)",
          "-webkit-touch-callout": "none"
        }), M.isie && b.opt.disableoutline && b.win.attr("hideFocus", "true"), M.iswebkit && b.opt.disableoutline && b.win.css({
          outline: "none"
        }));
        !1 === b.opt.autohidemode ? (b.autohidedom = !1, b.rail.css({
          ...
          opacity: b.opt.cursoropacitymax
        })) : !0 === b.opt.autohidemode ? (b.autohidedom = e().add(b.rail), M.isie8 && (b.autohidedom = b.autohidedom.add(b.cursor)), b.railh && (b.autohidedom = b.autohidedom.add(b.railh)), b.railh && M.isie8 && (b.autohidedom = b.autohidedom.add(b.cursorh))) : "scroll" == b.opt.autohidemode ? (b.autohidedom = e().add(b.rail), b.railh && (b.autohidedom = b.autohidedom.add(b.railh))) : "cursor" == b.opt.autohidemode ? (b.autohidedom = e().add(b.cursor), b.railh && (b.autohidedom = b.autohidedom.add(b.cursorh))) : "hidden" == b.opt.autohidemode && (b.autohidedom = !1, b.hide(), b.locked = !1);
        if (M.isie9mobile) b.scrollmom = new v(b), b.onmangotouch = function() {
          ...
          if (M.cantouch || b.istouchcapable || b.opt.touchbehavior || M.hasmstouch) {
            b.scrollmom = new v(b);
            b.ontouchstart = function(t) {
              if (t.pointerType && 2 != t.pointerType) return !1;
              if (!b.locked) {
                if (M.hasmstouch) for (var n = t.target ? t.target : !1; n; ) {
                ...
                b.opt.touchbehavior && b.isiframe && M.isie && (r = b.win.position(), b.rail.drag.x += r.left, b.rail.drag.y += r.top);
                b.hasmoving = !1;
                b.lastmouseup = !1;
                b.scrollmom.reset(t.clientX, t.clientY);
                if (!M.cantouch && !this.istouchcapable && !M.hasmstouch) {
                  if (!n || !/INPUT|SELECT|TEXTAREA/i.test(n.nodeName)) return !b.ispage && M.hasmousecapture && n.setCapture(), b.cancelEvent(t);
            ...
            b.ontouchend = function(e) {
              ...
              if (b.rail.drag && 2 == b.rail.drag.pt && (b.scrollmom.doMomentum(), b.rail.drag = !1, b.hasmoving && (b.hasmoving = !1, b.lastmouseup = !0, b.hideCursor(), M.hasmousecapture && document.releaseCapture(), !M.cantouch))) return b.cancelEvent(e);
            };
            var g = b.opt.touchbehavior && b.isiframe && !M.hasmousecapture;
            b.ontouchmove = function(t, n) {
              if (t.pointerType && 2 != t.pointerType) return !1;
              if (b.rail.drag && 2 == b.rail.drag.pt) {
                if (M.cantouch && "undefined" == typeof t.original) return !0;
                b.hasmoving = !0;
                ...
                r = !1;
                if (b.rail.drag.dl) r = !0, "v" == b.rail.drag.dl ? f = b.rail.drag.sl : "h" == b.rail.drag.dl && (a = b.rail.drag.st); else {
                  ...
                  if ("v" == b.rail.drag.ck) {
                    ...
                    if (u > l && i <= .3 * az) return b.rail.drag = !1, !0;
                    i > l && (b.rail.drag.dl = "f", e("body").scrollLeft(e("body").scrollLeft()));
                  }
                }
                b.synched("touchmove", function() {
                  b.rail.drag && 2 == b.rail.drag.pt && (b.prepareTransition && b.prepareTransition(0), b.rail.scrollable && b.setScrollTop(a), b.scrollmom.update(o, s), b.railh && b.railh.scrollable ? (b.setScrollLeft(f), b.showCursor(a, f)) : b.showCursor(a), M.isie10 && document.selection.clear());
                });
                M.ischrome && b.istouchcapable && (r = !1);
          ...
          b.onmousedown = function(e, t) {
            if (!b.rail.drag || 1 == b.rail.drag.pt) {
              ...
              var n = b.getTarget(e);
              !b.ispage && M.hasmousecapture && n.setCapture();
              b.isiframe && !M.hasmousecapture && (b.saved.csspointerevents = b.doc.css("pointer-events"), b.css(b.doc, {
                "pointer-events": "none"
              }));
              return b.cancelEvent(e);
            }
          ...
          b.onmouseup = function(e) {
            if (b.rail.drag && (M.hasmousecapture && document.releaseCapture(), b.isiframe && !M.hasmousecapture && b.doc.css("pointer-events", b.saved.csspointerevents), 1 == b.rail.drag.pt)) return b.rail.drag = !1, b.cancelEvent(e);
          };
          b.onmousemove = function(e) {
            if (b.rail.drag && 1 == b.rail.drag.pt) {
              if (M.ischrome && 0 == e.which) return b.onmouseup(e);
              b.cursorfreezed = !0;
              if (b.rail.drag.hr) {
          ...
          if (M.cantouch || b.opt.touchbehavior) b.onpreventclick = function(e) {
            if (b.preventclick) return b.preventclick.tg.onclick = b.preventclick.click, b.preventclick = !1, b.cancelEvent(e);
          }, b.bind(b.win, "mousedown", b.ontouchstart), b.onclick = M.isios ? !1 : function(e) {
            return b.lastmouseup ? (b.lastmouseup = !1, b.cancelEvent(e)) : !0;
          }, b.opt.grabcursorenabled && M.cursorgrabvalue && (b.css(b.ispage ? b.doc : b.win, {
          ...
          b.railh && (b.bind(b.cursorh, "mousedown", function(e) {
            ...
            if (!b.rail.drag || 2 != b.rail.drag.pt) return b.rail.drag = !1, b.hasmoving = !1, b.hideCursor(), M.hasmousecapture && document.releaseCapture(), b.cancelEvent(e);
          }));
          if (b.opt.cursordragontouch || !M.cantouch && !b.opt.touchbehavior) b.rail.css({
            cursor: "default"
          }), b.railh && b.railh.css({
            cursor: "default"
          ...
          !M.cantouch && !b.opt.touchbehavior ? (b.bind(M.hasmousecapture ? b.win : document, "mouseup", b.onmouseup), b.bind(document, "mousemove", b.onmousemove), b.onclick && b.bind(document, "click", b.onclick), !b.ispage && b.opt.enablescrollonselection && (b.bind(b.win[0], "mousedown", b.onselectionstart), b.bind(document, "mouseup", b.onselectionend), b.bind(b.cursor, "mouseup", b.onselectionend), b.cursorh && b.bind(b.cursorh, "mouseup", b.onselectionend), b.bind(document, "mousemove", b.onselectiondrag)), b.zoom && (b.jqbind(b.zoom, "mouseenter", function() {
            b.canshowonmouseevent && b.showCursor();
            b.rail.active = !0;
          }), b.jqbind(b.zoom, "mouseleave", function() {
            b.rail.active = !1;
            b.rail.drag || b.hideCursor();
          }))) : (b.bind(M.hasmousecapture ? b.win : document, "mouseup", b.ontouchend), b.bind(document, "mousemove", b.ontouchmove), b.onclick && b.bind(document, "click", b.onclick), b.opt.cursordragontouch && (b.bind(b.cursor, "mousedown", b.onmousedown), b.bind(b.cursor, "mousemove", b.onmousemove), b.cursorh && b.bind(b.cursorh, "mousedown", b.onmousedown), b.cursorh && b.bind(b.cursorh, "mousemove", b.onmousemove)));
          b.opt.enablemousewheel && (b.isiframe || b.bind(M.isie && b.ispage ? document : b.docscroll, "mousewheel", b.onmousewheel), b.bind(b.rail, "mousewheel", b.onmousewheel), b.railh && b.bind(b.railh, "mousewheel", b.onmousewheelhr));
          !b.ispage && !M.cantouch && !/HTML|BODY/.test(b.win[0].nodeName) && (b.win.attr("tabindex") || b.win.attr({
            tabindex: r++
        ...
        b.opt.enablekeyboard && b.bind(document, M.isopera && !M.isopera12 ? "keypress" : "keydown", b.onkeypress);
        b.bind(window, "resize", b.lazyResize);
        b.bind(window, "orientationchange", b.lazyResize);
        b.bind(window, "load", b.lazyResize);
        if (M.ischrome && !b.ispage && !b.haswrapper) {
        ...
        !b.ispage && !b.haswrapper && (!1 !== c ? (b.observer = new c(function(e) {
          ...
          attributes: !1,
          subtree: !1
        })) : (b.bind(b.win, M.isie && !M.isie9 ? "propertychange" : "DOMAttrModified", b.onAttributeChange), M.isie9 && b.win[0].attachEvent("onpropertychange", b.onAttributeChange), b.bind(b.win, "DOMNodeRemoved", function(e) {
      ...
      if ("IFRAME" == this.doc[0].nodeName) {
        var E = function() {
          ...
          if (!M.isios && b.opt.iframeautoresize && !b.isiframe) {
            b.win.scrollTop(0);
            b.doc.height("");
          ...
          b.opt.enablekeyboard && b.bind(t, M.isopera ? "keypress" : "keydown", b.onkeypress);
          if (M.cantouch || b.opt.touchbehavior) b.bind(t, "mousedown", b.onmousedown), b.bind(t, "mousemove", function(e) {
            b.onmousemove(e, !0);
          }), b.opt.grabcursorenabled && M.cursorgrabvalue && b.css(e(t.body), {
            cursor: M.cursorgrabvalue
          });
          b.bind(t, "mouseup", b.onmouseup);
    ...
    this.bind = function(e, t, n, r) {
      ...
      }, r || !1), b._bind(i, t, n, r || !1), M.cantouch && "mouseup" == t && b._bind(i, "touchcancel", n, r || !1)) : b._bind(i, t, function(e) {
    ...
    b.opt.smoothscroll ? b.ishwscroll && M.hastransition && b.opt.usetransition ? (this.prepareTransition = function(e, t) {
      var n = t ? 20 < e ? e : 0 : b.getTransitionSpeed(e), r = n ? M.prefixstyle + "transform " + n + "ms ease-out" : "";
      if (!b.lasttransitionstyle || b.lasttransitionstyle != r) b.lasttransitionstyle = r, b.doc.css(M.transitionstyle, r);
      return n;
      ...
      b.timer = setTimeout(function() {
        ...
        0 < i && (!b.scrollrunning && b.onscrollstart && b.onscrollstart.call(b, {
          ...
          speed: i
        }), M.transitionend ? b.scrollendtrapped || (b.scrollendtrapped = !0, b.bind(b.doc, M.transitionend, b.onScrollEnd, !1)) : (b.scrollendtrapped && clearTimeout(b.scrollendtrapped), b.scrollendtrapped = setTimeout(b.onScrollEnd, i)), b.timerscroll = {
      ...
      b._unbind(b.doc, M.transitionend, b.onScrollEnd);
      ...
      b.scrollendtrapped && b._unbind(b.doc, M.transitionend, b.onScrollEnd);
      b.scrollendtrapped = !1;
      b.prepareTransition(0);
      b.timerscroll && b.timerscroll.tm && clearInterval(b.timerscroll.tm);
      b.timerscroll = !1;
      ...
      var n = e > b.page.maxw ? b.page.maxw : e;
      0 > n && (n = 0);
      var r = t > b.page.maxh ? b.page.maxh : t;
      0 > r && (r = 0);
    ...
    this.doZoomIn = function(t) {
      if (!b.zoomactive) {
        ...
        M.isios4 && (b.zoomrestore.scrollTop = e(window).scrollTop(), e(window).scrollTop(0));
        b.win.css({
    ...
    this.doZoomOut = function(t) {
      if (b.zoomactive) return b.zoomactive = !1, b.win.css("margin", ""), b.win.css(b.zoomrestore.style), M.isios4 && e(window).scrollTop(b.zoomrestore.scrollTop), b.rail.css({
        "z-index": b.zindex
      }), b.zoom.css({
        "z-index": b.zindex
  ...
  e.cssHooks.pageYOffset = {
    get: function(t) {
      ...
      return n && n.ishwscroll ? n.getScrollTop() : m.call(t);
    },
    set: function(t, n) {
  ...
  e.cssHooks.pageXOffset = {
    get: function(t) {
      var n = e.data(t, "__nicescroll") || !1;
      return n && n.ishwscroll ? n.getScrollLeft() : g.call(t);
    },
    set: function(t, n) {
      var r = e.data(t, "__nicescroll") || !1;
  ...
  for (var y = function(t) {
    ...
    this.each = function(e) {
      for (var t = 0, r = 0; r < n.length; r++) e.call(n[r], t++);
      return n;
    };
    ...
    this.remove = function(e) {
      n.each(function(t) {
        this.id === e.id && (delete n[t], n.length--);
      });
    };
    this.eq = function(e) {
      return n[e];
    };
    if (t) for (a = 0; a < t.length; a++) {
      var r = e.data(t[a], "__nicescroll") || !1;
      r && (this[this.length] = r, this.length++);
    }
    return this;
  }, u = y.prototype, b = "show hide toggle onResize resize remove stop doScrollPos".split(" "), w = function(e, t) {
    e[t] = function() {
      var e = arguments;
      return this.each(function() {
        this[t].apply(this, e);
  ...
  e.nicescroll || (e.nicescroll = new y, e.nicescroll.options = h);
})(jQuery);