...
!function(e) {
  ...
  t.prototype = {
    ...
    init: function(t, n, r) {
      ...
      this.enabled = !0;
      if (this.options.trigger == "click") this.$element.on("click." + this.type, this.options.selector, e.proxy(this.toggle, this)); else if (this.options.trigger != "manual") {
...
$(function() {
  var e = document.querySelector && document.querySelector('meta[name="viewport"]'), t = navigator.userAgent, n = function() {
    e.content = "width=device-width, minimum-scale=0.25, maximum-scale=1.6";
  }, r = function() {
    if (e && /iPhone|iPad/.test(t) && !/Opera Mini/.test(t)) {
      e.content = "width=device-width, minimum-scale=1.0, maximum-scale=1.0";
      document.addEventListener("gesturestart", n, !1);
    }
  };
  r();
  if (window.orientation != undefined) {
    var i = /ipod|ipad|iphone/gi, s = t.match(i);
    s || $(".sf-menu li").each(function() {
...
(function(e) {
  ...
  function n(t) {
    ...
    var n = e.data(this, "ui-accordion"), r = n.options;
    r.running = t ? 0 : --r.running;
    if (r.running) return;
    r.clearStyle && r.toShow.add(r.toHide).css({
      height: "",
      overflow: ""
    });
  ...
  function r(r, i, s, o, u) {
    ...
    if (a.animated) !a.alwaysOpen && o ? e.ui.accordion.animations[a.animated]({
      toShow: jQuery([]),
      toHide: i,
      complete: f,
      down: u,
      ...
      if (!a.alwaysOpen && o) r.toggle(); else {
        i.hide();
        r.show();
      }
      f(!0);
  ...
  function i(t) {
    ...
    var u = e(t.target);
    if (u.parents(n.header).length) while (!u.is(n.header)) u = u.parent();
    var a = u[0] == n.active[0];
    if (n.running || n.alwaysOpen && a) return !1;
    if (!u.is(n.header)) return;
    n.active.parent().andSelf().toggleClass(n.selectedClass);
    a || u.parent().andSelf().addClass(n.selectedClass);
    var o = u.next(), i = n.active.next(), s = {
      instance: this,
      options: n,
      newHeader: u,
      oldHeader: n.active,
  ...
  function s(t, n) {
    return n != undefined ? typeof n == "number" ? t.filter(":eq(" + n + ")") : t.not(t.not(n)) : n === !1 ? e([]) : t.filter(":eq(0)");
  }
  e.ui = e.ui || {};
  e.fn.extend({
    accordion: function(t, n) {
      ...
      return this.each(function() {
        if (typeof t == "string") {
          ...
          n[t].apply(n, r);
        } else e(this).is(".ui-accordion") || e.data(this, "ui-accordion", new e.ui.accordion(this, t));
      });
    },
    activate: function(e) {
  ...
  e.ui.accordion = function(t, n) {
    ...
    if (n.navigation) {
      ...
      if (r.length) if (r.filter(n.header).length) n.active = r; else {
    ...
    n.event && e(t).bind(n.event + ".ui-accordion", i);
  };
  e.ui.accordion.prototype = {
    ...
    destroy: function() {
      ...
      (this.options.fillSpace || this.options.autoheight) && this.options.headers.next().css("height", "");
  ...
  e.extend(e.ui.accordion, {
    ...
    animations: {
      slide: function(t, n) {
        ...
        var r = t.toHide.height(), i = t.toShow.height(), s = i / r;
        t.toShow.css({
          height: 0,
          overflow: "hidden"
        }).show();
        t.toHide.filter(":hidden").each(t.complete).end().filter(":visible").animate({
          height: "hide"
        }, {
          step: function(n) {
            var i = (r - n) * s;
            if (e.browser.msie || e.browser.opera) i = Math.ceil(i);
            t.toShow.height(i);
          },
          duration: t.duration,
          easing: t.easing,
          complete: function() {
            t.autoheight || t.toShow.css("height", "auto");
            t.complete();
          }
        });
      },
...
$(window).load(function() {
  $(document).width() > 480 && $(".maxheight").length && $(".maxheight").equalHeights();
});
